...
MODULES = [
    Module(name='go.felesatra.moe/anaclock',
           repo='https://github.com/darkfeline/anaclock'),
    Module(name='go.felesatra.moe/anidb',
           repo='https://github.com/darkfeline/anidb-go'),
    Module(name='go.felesatra.moe/animanager',
           repo='https://github.com/darkfeline/animanager-go'),
    Module(name='go.felesatra.moe/binpack',
           repo='https://github.com/darkfeline/binpack'),
    Module(name='go.felesatra.moe/cloudflare',
    ...
    Module(name='go.felesatra.moe/database/sql/sqlite3/migrate',
           repo='https://github.com/darkfeline/go-sqlite3-migrate'),
    Module(name='go.felesatra.moe/dlsite',
           repo='https://github.com/darkfeline/dlsite-go'),
    Module(name='go.felesatra.moe/dlsite/v2',
           repo='https://github.com/darkfeline/dlsite-go'),
    Module(name='go.felesatra.moe/dlsite-cmd',
           repo='https://github.com/darkfeline/dlsite-cmd-go'),
    Module(name='go.felesatra.moe/encoding/sexp',
           repo='https://github.com/darkfeline/go-sexp'),
    Module(name='go.felesatra.moe/go2/errors',
           repo='https://github.com/darkfeline/go2-errors'),
    Module(name='go.felesatra.moe/hash/ed2k',
           repo='https://github.com/darkfeline/ed2k-go'),
    Module(name='go.felesatra.moe/keeper',
           repo='https://github.com/darkfeline/keeper-go'),
    Module(name='go.felesatra.moe/linelist',
           repo='https://github.com/darkfeline/go-linelist'),
    Module(name='go.felesatra.moe/pwnck',
           repo='https://github.com/darkfeline/pwnck'),
    Module(name='go.felesatra.moe/qualia',
           repo='https://github.com/darkfeline/qualia-go'),
    Module(name='go.felesatra.moe/saucenao',
           repo='https://github.com/darkfeline/saucenao'),
    Module(name='go.felesatra.moe/sitemap',
           repo='https://github.com/darkfeline/sitemap-go'),
    Module(name='go.felesatra.moe/xdg',
